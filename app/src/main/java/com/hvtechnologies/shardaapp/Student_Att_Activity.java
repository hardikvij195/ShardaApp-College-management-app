...
public class Student_Att_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student__att_);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        Subs = (ListView)findViewById(R.id.lstAtt);
        ...
        Subs.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent mainIntent = new Intent(Student_Att_Activity.this, Student_Particulat_Sub_Attendance_Activity.class);
