 ...
 * {@link Student_Attendance_Frag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Student_Attendance_Frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Student_Attendance_Frag extends Fragment {
    ...
    public Student_Attendance_Frag() {
     ...
     * @return A new instance of fragment Student_Attendance_Frag.
     */
    // TODO: Rename and change types and number of parameters
    public static Student_Attendance_Frag newInstance(String param1, String param2) {
        Student_Attendance_Frag fragment = new Student_Attendance_Frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_student__attendance_, container, false);
        Utils.getDatabase();

        btn1 = (CardView)v.findViewById(R.id.cardview);
        RcView = (RecyclerView)v.findViewById(R.id.recyclerView);

        final Intent intent1 = new Intent(getActivity(), Student_Att_Activity.class);
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                        ...
                        if(day.contains(formattedDate)){
                            ...
                            String Loc = dataSnapshot1.child("SubName").getValue().toString();
                            String Sub = dataSnapshot1.child("Att").getValue().toString();
