...
public class Dean_AllTT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dean__all_tt);
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        if(dataSnapshot.exists()){
                            ...
                            for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()){
                                ...
                                String Groups = dataSnapshot1.child("Groups").getValue().toString();

                                mTeachTT.add(new TeacherTimeTableClass( Sch , Dept , Year , Class + " - " + Groups  , Sub , SubCode , Loc , Time));
                                adapter.notifyDataSetChanged();
