 ...
 * {@link Student_Notice_Frag.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Student_Notice_Frag#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Student_Notice_Frag extends Fragment {
     ...
     * @return A new instance of fragment Student_Notice_Frag.
     */
    // TODO: Rename and change types and number of parameters
    public static Student_Notice_Frag newInstance(String param1, String param2) {
        Student_Notice_Frag fragment = new Student_Notice_Frag();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v =  inflater.inflate(R.layout.fragment_student__notice_, container, false);
        Utils.getDatabase();
        ...
        final Intent intent1 = new Intent(getActivity(), Student_View_Notices.class);
        ...
        InfoRef = FirebaseDatabase.getInstance().getReference("Notices/ClassWise/" + Id1 + "/" + Id2 + "/"+ Id3 + "/"+ Id4 + "/" ) ;
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                        ...
                        if(day.contains(formattedDate)){
                            ...
                            //String Loc = dataSnapshot1.child("Topic").getValue().toString();
                            //String Sub = dataSnapshot1.child("Desc").getValue().toString();
                            //String SubCode = dataSnapshot1.child("Date").getValue().toString();
                            //String Teach = dataSnapshot1.child("ByName").getValue().toString();
                            //String Time = dataSnapshot1.child("ByCode").getValue().toString();
